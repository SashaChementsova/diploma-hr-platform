...
@Controller
public class HrLanguageQuestionsController {
    ...
    @Autowired
    public HrLanguageQuestionsController(LanguageNameService languageNameService, LanguageService languageService, LevelLanguageService levelLanguageService, LanguageTestQuestionService languageTestQuestionService) {
    ...
    @GetMapping("/hr/languageQuestions")
    public String getLanguageQuestions(LanguageName languageName,LevelLanguage levelLanguage,Model model) {
        ...
        return "hr/languageQuestionsControl/getLanguageQuestions.html";
    }

    @GetMapping("/hr/addLanguageQuestion")
    ...
    @PostMapping("/hr/addLanguageQuestion/end")
    public String addLanguageQuestionEnd(LanguageTestQuestion languageTestQuestion,LanguageName languageName,LevelLanguage levelLanguage, Model model){
        ...
        return "redirect:/hr/languageQuestions";
    }
    @GetMapping("/hr/editLanguageQuestion/{id}")
    ...
    @PostMapping("/hr/editLanguageQuestion/end")
    ...
    @GetMapping("/hr/deleteLanguageQuestion/{id}")
    ...
    @PostMapping("/hr/deleteLanguageQuestion/end")
