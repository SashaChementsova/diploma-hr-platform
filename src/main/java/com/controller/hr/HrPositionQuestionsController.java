...
@Controller
public class HrPositionQuestionsController {
    ...
    @Autowired
    public HrPositionQuestionsController(UserDetailService userDetailService,EmployeeService employeeService,PositionNameService positionNameService, PositionService positionService, LevelPositionService levelPositionService, PositionTestQuestionService positionTestQuestionService) {
    ...
    @GetMapping("/hr/positionQuestions")
    public String getPositionQuestions(LevelPosition levelPosition, Model model) {
        ...
        return "hr/positionQuestionsControl/getPositionQuestions.html";
    }

    @GetMapping("/hr/addPositionQuestion")
    ...
    @PostMapping("/hr/addPositionQuestion/end")
    public String addPositionQuestionEnd(PositionTestQuestion positionTestQuestion,LevelPosition levelPosition, Model model){
        ...
        return "redirect:/hr/positionQuestions";
    }
    @GetMapping("/hr/editPositionQuestion/{id}")
    ...
    @PostMapping("/hr/editPositionQuestion/end")
    ...
    @GetMapping("/hr/deletePositionQuestion/{id}")
    ...
    @PostMapping("/hr/deletePositionQuestion/end")
